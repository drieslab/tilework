...
#' of `FUN` begins.
#' @export
setMethod("tileApply", signature("token", "missing", "tileIterator"),
...
#' of `FUN` begins.
#' @export
setMethod("tileApply", signature("token", "token", "tileIterator"),
...
#' @export
setMethod("redispatch_tileapply", signature("character", "tileIterator"),
function(sig, tiles, ...) {
...
#' @rdname redispatch_tileapply
#' @export
setMethod("redispatch_tileapply", signature("ANY", "tileIterator"), function(sig, tiles,
